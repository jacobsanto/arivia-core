-- Temporarily disable the trigger to create privileged profiles
ALTER TABLE public.profiles DISABLE TRIGGER prevent_privileged_profile_insert_trigger;

-- Create the proper profiles with correct roles
...
ALTER TABLE public.profiles ENABLE TRIGGER prevent_privileged_profile_insert_trigger;