...
CREATE INDEX IF NOT EXISTS idx_external_integrations_category ON public.external_integrations(category);
CREATE INDEX IF NOT EXISTS idx_external_integrations_status ON public.external_integrations(status);
CREATE INDEX IF NOT EXISTS idx_api_logs_integration_id ON public.api_logs(integration_id);
CREATE INDEX IF NOT EXISTS idx_api_logs_created_at ON public.api_logs(created_at);
CREATE INDEX IF NOT EXISTS idx_webhook_endpoints_integration_id ON public.webhook_endpoints(integration_id);
