-- Update the handle_new_user trigger to properly set roles in user_roles table
-- and ensure only one superadmin can exist

-- First, update the trigger function to check for existing superadmin
...
-- Add a constraint to ensure only one superadmin can exist
