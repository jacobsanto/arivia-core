-- Temporarily disable all triggers on guesty_bookings to allow data insertion
ALTER TABLE guesty_bookings DISABLE TRIGGER ALL;
...
-- Re-enable triggers
ALTER TABLE guesty_bookings ENABLE TRIGGER ALL;
...
UPDATE auth.config SET 
  ...
  password_require_upper_case = false
WHERE true;