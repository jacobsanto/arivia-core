...
import TaskRejectionReason from "./TaskRejectionReason";
import TaskActions from "./TaskActions";
import TaskCleaningDetails from "./TaskCleaningDetails";
      ...
      <Card className={cardClasses}>
        ...
        <CardContent className="space-y-6">
          ...
          {task.cleaningDetails && (
            <TaskCleaningDetails cleaningDetails={task.cleaningDetails} />
          )}
