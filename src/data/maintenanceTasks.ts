...
export const initialTasks = [
  ...
  // Adding more tasks to demonstrate the daily agenda
  {
    id: 4,
    title: "HVAC System Check at Villa Oceana",
    property: "Villa Oceana",
    type: "Maintenance",
    status: "Pending",
    priority: "Medium",
    dueDate: "2025-04-12T16:30:00", // Today
    assignee: "Alex Chen",
    description: "Quarterly preventative maintenance check on all HVAC systems",
    location: "All floors, mechanical rooms",
    requiredTools: ["HVAC toolkit", "Air quality meter", "Filter replacements"],
    instructions: [
      { id: 1, title: "Check filter status", completed: false },
      { id: 2, title: "Clean condenser and evaporator coils", completed: false },
      { id: 3, title: "Test thermostat function", completed: false },
      { id: 4, title: "Check refrigerant levels", completed: false },
    ],
    beforePhotos: [],
    afterPhotos: [],
  ...
  {
    id: 5,
    title: "Pool Equipment Maintenance at Villa Paradiso",
    property: "Villa Paradiso",
    type: "Maintenance",
    status: "Pending",
    priority: "Low",
    dueDate: "2025-04-12T09:00:00", // Today morning
    assignee: "Maria Kowalska",
    description: "Check pool pump, heater, and filter system",
    location: "Pool equipment room, exterior",
    requiredTools: ["Pool test kit", "Chlorine tablets", "Filter cleaner"],
    instructions: [
      { id: 1, title: "Test water chemistry", completed: false },
      { id: 2, title: "Check pump operation", completed: false },
      { id: 3, title: "Clean skimmer baskets", completed: false },
      { id: 4, title: "Backwash filter if needed", completed: false },
    ],
    beforePhotos: [],
    afterPhotos: [],
    beforeVideos: [],
