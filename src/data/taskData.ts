...
export const initialTasks: Task[] = [
  {
    ...
    status: "Pending",
    priority: "High",
    dueDate: "2025-04-12T14:00:00", // Set to today
    assignedTo: "Maria Kowalska",
  ...
  },
  {
    ...
    status: "Pending",
    priority: "Medium",
    dueDate: "2025-04-12T10:00:00", // Set to today morning
    assignedTo: "Stefan Müller",
  ...
  {
    id: "7",
    title: "Villa Sunset Guest Welcome Prep",
    property: "Villa Sunset",
    type: "Housekeeping",
    status: "Pending",
    priority: "High",
    dueDate: "2025-04-12T17:30:00", // Today evening
    assignedTo: "Ana Rodriguez",
    description: "Prepare welcome amenities and room setup for new guests",
    approvalStatus: null,
    rejectionReason: null,
    photos: [],
    checklist: [
      { id: 1, title: "Set up welcome basket", completed: false },
      { id: 2, title: "Prepare welcome letter", completed: false },
      { id: 3, title: "Stock refrigerator with ordered items", completed: false },
      { id: 4, title: "Arrange fresh flowers", completed: false },
      { id: 5, title: "Set climate control", completed: false },
    ],
  },
  {
    id: "8",
    title: "Villa Azure Pool Area Cleaning",
    property: "Villa Azure",
    type: "Housekeeping",
    status: "Pending",
    priority: "Medium",
    dueDate: "2025-04-12T11:30:00", // Today morning
    assignedTo: "Thomas Lindberg",
    description: "Clean and prepare pool area for afternoon guest use",
    approvalStatus: null,
    rejectionReason: null,
    photos: [],
    checklist: [
      { id: 1, title: "Clean pool surfaces", completed: false },
      { id: 2, title: "Arrange pool furniture", completed: false },
      { id: 3, title: "Replace pool towels", completed: false },
      { id: 4, title: "Clean BBQ area", completed: false },
